...
- **Queue complete grace period** — Keeps completed downloads visible to clients before removing from queue; jobs are inserted into history immediately for *arr visibility
